...
<div style="max-width:680px;margin:0 auto;">
  ...
  <div style="background:white;padding:32px;border-radius:0 0 12px 12px;">
    ...
    <p style="margin:32px 0 0;font-size:12px;color:#9ca3af;text-align:center;">
      Generated by nGenius Prep ACT Grader &middot;
      <a href="https://score.ngeniusprep.com" style="color:#1d4ed8;text-decoration:none;">score.ngeniusprep.com</a>
    </p>
  </div>
</div>
</body>
  ...
  try {
    const pmRes = await fetch('https://api.postmarkapp.com/email', {
      ...
      body: JSON.stringify({
        ...
        To: toAddr,
        ...(ccAddr ? { Cc: ccAddr } : {}),
        Subject: `ACT Score Report — ${studentName || 'Student'} — ${testName || ''}`,
        HtmlBody: html,
